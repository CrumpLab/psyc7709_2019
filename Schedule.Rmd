...
b. Create and share an R package containing custom functions on github. Follow the instructions in the [R package assignment](https://crumplab.github.io/psyc7709/Presentations/RPackages.html) that we will discuss in class. Upload the link to your new github repository containing your R package to blackboard.

tips: I added a video showing how to [create a new R package and publish it to github.com](https://crumplab.github.io/psyc7709/Videos.html#publish_r_package_to_github)

c. **NEW** this an addition to your assignment not discussed in class. The assignment instructions are in the [github assignment](https://crumplab.github.io/psyc7709/Presentations/Github.html) document. This assignment gives you more practice using github features. You will be forking a repo, adding to the code, then making a pull-request to have your new changes be incorporated into the master repository. Also, you will be able to see other students solutions to two of the harder programming problems.

tips: I added a video showing how to [fork and make a pull request](https://crumplab.github.io/psyc7709/Videos.html#fork_a_repo_and_make_a_pull_request)
...
Your assignment is to practice making graphs in ggplot2. [Click this link to see the assignment instructions](https://crumplab.github.io/psyc7709/Presentations/DataVis.html). You will be making a new R markdown page documenting your code for making graphs in the assignment. Load this page onto your website, then submit the link to the page on blackboard.
...
1. [Class notes on Data-wrangling](https://crumplab.github.io/psyc7709/Presentations/DataWrangling.html)
2. [Example R Markdown analysis report](https://crumplab.github.io/psyc7709/Presentations/DataWrangleExampleStroop.html)
3. [Your Rmarkdown Assignment](https://crumplab.github.io/psyc7709/Presentations/DataWrangleFlanker_student.Rmd) This links to the .rmd file, that you can use as a template to complete the assignment. Using this template file, create a new page on your website, and submit the link
4. [Answer sheet for assignment](https://crumplab.github.io/psyc7709/Presentations/DataWrangleFlanker.html) You can use this to check your work. If you don't get the same numbers, then one of us did something wrong.
...
1. [Class notes on Statistics](https://crumplab.github.io/psyc7709/Presentations/Statistics.html)
...
- [Statistics Assignment](https://crumplab.github.io/psyc7709/Presentations/StatisticsAssignment.html), due M Mar 25th
  - This assignment asks you to simulate the null hypothesis in various ways using R.
- The [midterm project](https://crumplab.github.io/psyc7709/MidtermAssignment.html) begins this week (due aprill 8th)
...
1. [Installing papaja](https://crumplab.github.io/psyc7709/Presentations/papaja.html)
...
[midterm project](https://crumplab.github.io/psyc7709/MidtermAssignment.html)
...
1. [Class notes on simulation](https://crumplab.github.io/psyc7709/Presentations/Simulation.html)
2. [Matthew Crump's, Programming for Psychologists, chapter 5](https://crumplab.github.io/programmingforpsych/simulating-and-analyzing-data-in-r.html)
...
1. [Class Notes on Shiny](https://crumplab.github.io/psyc7709/Presentations/Shiny_tutorial.html)
...
1. [Class notes on optimization](https://crumplab.github.io/psyc7709/Presentations/Optimization.html)
...
3. [example presentation](https://crumplab.github.io/psyc7709/FinalPresentation/RPackagePresentation.html#1)
