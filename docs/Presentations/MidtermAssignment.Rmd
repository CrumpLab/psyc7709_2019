...
Your midterm assignment is due Monday April 8th. The midterm assignment involves a few different parts, that build on each other.

**Part 1 (Due March 25th)**

1. Make a new github repository for your midterm project. Put your work in this repository
2. Find a psych paper with open data (publically accesible and downloadable)
...
4. A brief discussion of whether you were succesful or not.
...
In part 3 you will add a simulation-based power analysis to your APA-style manuscript. We will discuss how to conduct simulation based power analyses in class.
