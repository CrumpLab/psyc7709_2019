...
1. Assume your samples come from a normal distribution with mean =0, sd =1.
2. Assume sample size for each sample is n =10
...
4. Compare the two sets of probabilites to show that the difference is small. What happens to the difference if the simulation is repeated fewer times (e.g., 100) vs. more times (e.g., 100,000)
